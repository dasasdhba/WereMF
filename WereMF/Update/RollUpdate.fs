...
let rollReset () = monad {
    ...
    let rec loop r =
        ...
        sendMessage { Type = ToPlayer player ; Content = newChara.ToString() }
...
let rollSetLeaf () = monad {
    ...
    let r = 
        ...
        | Some leaf ->
            ...
            sendMessage { Type = ToPlayer player ; Content = $"第一身份：{result.Head}" }
            ...
            sendMessage { Type = ToPlayer player ; Content = $"第一身份：{list.Head}" }
